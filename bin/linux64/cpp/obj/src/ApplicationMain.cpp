...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("beamsyn.net"),HX_CSTRING("Main"),HX_CSTRING("com.beamsyn.candyapplekingsaga/"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)60,(int)3355443,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int(::flash::Lib_obj::VSYNC))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Candy Apple King Saga"),null(),null());
	}
return null();
}
