...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("beamsyn.net", "Main", "com.beamsyn.candyapplekingsaga/", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Candy Apple King Saga", null, { width: 800, height: 600 });
